...
import { obtenerRankingSemanal } from '../actions/ranking'
...
export default function RankingPage() {
  ...
  const cargarRanking = async () => {
    ...
    const resultado = await obtenerRankingSemanal()
      ...
      <main className="relative min-h-screen overflow-hidden bg-black flex items-center justify-center px-4">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-gray-400 mt-3">
            Preparando a los mejores jugadores
          </p>
        </div>
      </main>
    )
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400 mt-1">
                            {item.partidas_jugadas} partidas · mejores{' '}
                            {item.mejores_partidas_contadas}
                          </p>
                        </div>
                      </div>
